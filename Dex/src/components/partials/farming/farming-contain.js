    ...
    return (
        <div className="default-hero__container">
            <div className="default-hero__body">
                ...
                <h2 className="default-hero__subtitle">Hexa Farms offer multiple farming opportunities to you. Get double rewards by staking your LP tokens in return for additional BSW tokens and earning high income from swap transactions. Learn how to start</h2>
                <a href="#add-product">
