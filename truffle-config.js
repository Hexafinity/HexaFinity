...
const testNet = new HDWalletProvider(mnemonic, infuraURL);
...
module.exports = {
  ...
  networks: {
    ...
    rinkeby: {
      provider: () => testNet,
      network_id: 4,       // testnets's id
      gas: 5500000,         // test has a lower block limit than mainnet
      gasPrice: 10000000000,         // test has a lower block limit than mainnet
